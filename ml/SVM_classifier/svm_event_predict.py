...
input_file = 'D:\\Books\\Python\\Python机器学习经典实例代码\\Chapter03\\building_event_binary.txt'
#input_file = 'D:\\Books\\Python\\Python机器学习经典实例代码\\Chapter03\\building_event_multiclass.txt'
...
input_data_encoded = input_data_encoded.reshape(1, len(input_data))  # 将数组转为一维数组，满足predict函数对数组大小的要求
